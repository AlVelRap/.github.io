window.onload = () => {
    ...
    let edges = calculateEdges(vertex)
...
/**
 * 
 * @param {matrix|vector} matrix1 
 * @param {matrix|vector} matrix2 
...
/**
 * 
 * @param {matrix|point} vertex 
 * @param {vector} translationVector 
 * @returns {matrix|point} <p>the given matrix with the translation given<p>
 */
...
/**
 * 
 * @param {matrix|point} vertex matrix with the points we want to rotate
 * @param {point} centerPoint the point around which we want to rotate
 * @param {*} angleZ in degrees
 * @param {*} angleY in degrees
 * @param {*} angleX in degrees
 * @returns {matrix|point} <p>the given matrix with the rotation given around the given center<p>
 */
function rotate(vertex, centerPoint, angleZ, angleY, angleX) {
    ...
    radiansZ = Math.PI / 180 * parseFloat(angleZ)
    radiansY = Math.PI / 180 * parseFloat(angleY)
    radiansX = Math.PI / 180 * parseFloat(angleX)
 ...
 * @returns 
 */
function calculateEdges(vertex){
    return edges = [
        { // 0
